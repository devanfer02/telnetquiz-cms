...
export const Route = createFileRoute("/dashboard")({
	loader: () => ({
		recentSubmission: generateHistory(100),
		averageScores: generateAverageScoreByChapter(),
	}),
	component: DashboardIndex,
});

function DashboardIndex() {
	const { recentSubmission, averageScores } = Route.useLoaderData();
