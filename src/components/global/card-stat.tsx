...
export default function CardStat({ icon: Icon, title, counter, target }: CardStatProps) {
  return (
    <Link to={target}>
      <Card className="flex items-center gap-4 p-4 hover:bg-telnet-primary duration-200 group cursor-pointer">
        ...
        <div className="text-center">
          <h3 className="text-xs lg:text-sm font-medium text-muted-foreground group-hover:text-white">{title}</h3>
